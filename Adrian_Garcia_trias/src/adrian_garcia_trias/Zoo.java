       ...
       switch (opcion) {
		   ...
		   if (oaves == 1){//pruebas cosas sin sentido soy consicente de ello
			   ...
			   try{
				 ...
				 else listaAnimalesOrdenada.add(listaAnimales.get(i+1));//se que no funciona como toca pero es por el tiempo que he tardado en obtener logitud de vuelo, pero seria buscar el algoritmo y ya
			   ...
			   try{
				 ...
				 else listaAveTemporal.add(listaAnimales.get(i+1));//se que no funciona como toca pero es por el tiempo que he tardado en obtener logitud de vuelo, pero seria buscar el algoritmo y ya
